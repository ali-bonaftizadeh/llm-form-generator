...
import org.activiti.app.service.editor.AISupportedActivitiFormService;
...
public class FormResource {
    ...
    @Autowired
    protected AISupportedActivitiFormService aiSupportedActivitiFormService;
    ...
    @RequestMapping(value = "/generate-from-prompt", method = RequestMethod.GET, produces = "application/json")
    public FormDefinition generateFormFromPrompt(@RequestParam String prompt) {
        return aiSupportedActivitiFormService.generateFormFromPrompt(prompt);
    }
}
